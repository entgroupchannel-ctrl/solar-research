...
const PERSONAL_QUESTIONS = [
  ...
  },
  {
    ...
    options: ["บ้านเดี่ยว", "ทาวน์เฮาส์", "คอนโดมิเนียม", "อาคารพาณิชย์", "โรงงาน/อาคารอุตสาหกรรม"],
  },
  {
    id: "household",
    text: "จำนวนสมาชิกในครัวเรือน",
    options: ["1-2 คน", "3-4 คน", "5-6 คน", "มากกว่า 6 คน"],
  },
  {
    id: "electricity_bill",
    text: "ค่าไฟฟ้าเฉลี่ยต่อเดือน",
    options: ["ต่ำกว่า 2,000 บาท", "2,001-5,000 บาท", "5,001-10,000 บาท", "มากกว่า 10,000 บาท"],
  },
  {
    id: "peak_usage",
    text: "ช่วงเวลาที่ใช้ไฟฟ้าสูงสุด",
    options: ["กลางวัน (08:00-17:00)", "กลางคืน (17:00-22:00)", "ใช้ตลอดทั้งวันเท่า ๆ กัน"],
  },
  {
    id: "ev_car",
    text: "การมีรถยนต์ไฟฟ้า (EV)",
    options: ["มี EV แล้ว", "วางแผนจะซื้อ EV", "ไม่มีและไม่สนใจ"],
  },
  {
    id: "solar_size",
    text: "ขนาดระบบโซลาร์รูฟท็อปที่ติดตั้ง",
    options: ["ต่ำกว่า 3 kW", "3-5 kW", "5-10 kW", "มากกว่า 10 kW"],
  },
  {
    id: "info_source",
    text: "แหล่งข้อมูลหลักที่ใช้ตัดสินใจติดตั้ง",
    options: ["โซเชียลมีเดีย", "เพื่อน/ญาติแนะนำ", "ตัวแทนจำหน่าย", "งานแสดงสินค้า", "อื่น ๆ"],
  },
];
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: 14, fontWeight: 700, color: "#0f172a", fontFamily: "monospace" }}>{responseId}</div>
          </div>
